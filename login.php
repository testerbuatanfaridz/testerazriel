...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Azriel Tour Organizer</title>
						...
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<br><center><p>Repost by <a href='http://faridzalfian.rf.gd/' title='faridzalfian.rf.gd' target='_blank'>faridzalfian.rf.gd</a></p></center>
				...
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Perusahaan kami bergerak di bidang penyewaan jasa tour and travel. kami melayani untuk melakukan tour di Seluruh Wilayah Indonesia.</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Desa Mekarmukti RT01/RW02, Sukamukti, Kec. Cilawu, Kabupaten Garut, Jawa Barat 44181</li>
								<li><i class="icon-phone2"></i>087880870506</li>
								<li><i class="icon-mail"></i><a href="#">Azrieltourism@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.Azrieltourism.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
