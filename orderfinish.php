        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
					...
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">Azriel Tour Organizer</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Azriel, <?php echo $date; ?></span>
        ...
        <tr>
            ...
            <td style="width: 75%">
                <div class="zone" style="height: 40mm;vertical-align: middle; text-align: justify">
                    <b>Ketentuan :</b><br>
					1. Perubahan Paket dan Penginapan silahkan hubungi contact person kami yang ada pada website, dan hanya bisa dilakukan 5 hari sebelum hari keberangkatan tour. Kurang dari itu perubahan tidak bisa dilakukan.<br>
                    ...
                    <br>HUBUNGI TLP/WA Di : 0878-8087-0506 dan sertakan Bukti Ini.<br>
